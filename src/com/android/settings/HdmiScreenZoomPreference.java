...
public class HdmiScreenZoomPreference extends SeekBarDialogPreference implements
    ...
    public HdmiScreenZoomPreference(Context context, AttributeSet attrs) {
        ...
        /*
         * try { mDisplayManagement = new DisplayOutputManager(); }catch
         * (RemoteException doe) { mDisplayManagement = null; } if
         * (mDisplayManagement != null && mDisplayManagement.getDisplayNumber()
         * == 0) mDisplayManagement = null;
         */
    }
    ...
    protected void onBindDialogView(View view) {
        ...
        Rect overscan;
        /*
         * if(mDisplayManagement != null){ if
         * (mDisplayManagement.getDisplayNumber() == 2) overscan =
         * mDisplayManagement.getOverScan(mDisplayManagement.AUX_DISPLAY); else
         * overscan =
         * mDisplayManagement.getOverScan(mDisplayManagement.MAIN_DISPLAY);
         * mOldScale = overscan.left - 80; }else{
         */
    ...
    private class HdmiScaleTask extends AsyncTask<Integer, Void, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            ...
            /*
             * if(mDisplayManagement != null){ int value = params[0]; if
             * (mDisplayManagement.getDisplayNumber() == 2)
             * mDisplayManagement.setOverScan(mDisplayManagement.AUX_DISPLAY,
             * mDisplayManagement.DISPLAY_OVERSCAN_ALL, value); else
